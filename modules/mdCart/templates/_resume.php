...
<fieldset>
  ...
  <table collspan="0" cellspacing="0" >
    ...
    <?php foreach ($orderItems as $orderItem): ?>
      <tr>
        <td><a href="<?php echo url_for('ec-producto-show', $orderItem->getEcProduct()); ?>" title="<?php echo $orderItem->getItemName(); ?>"><?php echo truncate_text($orderItem->getItemName(), 36); ?></a></td>
