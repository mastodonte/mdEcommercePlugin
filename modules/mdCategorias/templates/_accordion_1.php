  ...
  <div class="box-content">
    <div class="box-category">
      ...
      <?php foreach ($categorias as $record_categoria): ?>
        ...
        <li>
          <a class="<?php echo ($record_categoria['id'] ==  $categoria->getId() ? 'active' : ''); ?>" 
          ...
          <?php if ($hasChildren): ?>
            ...
            <ul>
              ...
              <?php foreach ($subcategorias as $subcategoria): ?>
                ...
                <li>            
                  <a href="<?php echo ($hasChildren ? 'javascript:void(0)' : url_for('@productos-categoria?id=' . $subcategoria['id'] . '&name=' . mdBasicFunction::slugify($subcategoria['name'])) . '?s=' . base64_encode($record_categoria['id'] . '-' . $record_categoria['name'])); ?>"><?php echo $subcategoria['name']; ?></a>
                </li>
