 ...
 */
abstract class PluginecAbitab extends BaseecAbitab
{
  ...
  public static function create($md_order_id){
    ...
    $link = url_for('@payment-abitab?c=' . $code , true);
    
    Tools::sendCustomerMail('abitab', $mdUser->getEmail(), $register->getMdOrder(), $link);
   ...
   * el registro ecAbitab correspondiente
   * 
   * @param string $code
   * @return ecAbitab 
   */
  public static function checkOrderParams($code){
    ...
    // Validamos registro
    $register = Doctrine::getTable('ecAbitab')->find($register_id);
    if($register)
    {
