 ...
 */
abstract class PluginecRedPagos extends BaseecRedPagos
{
  ...
  public static function create($md_order_id){
    ...
    $link = url_for('@payment-redpagos?c=' . $code , true);
    
    Tools::sendCustomerMail('redpagos', $mdUser->getEmail(), $register->getMdOrder(), $link);
   ...
   * el registro ecRedPagos correspondiente
   * 
   * @param string $code
   * @return ecRedPagos 
   */
  public static function checkOrderParams($code){
    ...
    // Validamos registro
    $register = Doctrine::getTable('ecRedPagos')->find($register_id);
    if($register)
    {
